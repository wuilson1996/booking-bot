...
class BookingSearch:
    ...
    @classmethod
    def controller(cls, driver:webdriver.Chrome, _now:dt.now=dt.now(), date_end=list(), occupancy=2, start=4, p=None):
        driver.get(cls._url)
        ...
        try:
            ...
            _button.click()
            logging.info("[+] click in button cookies")
        ...
        try:
            ...
            while True:
                ...
                #     #logging.info(b2.get_attribute("innerHTML"))
                #     #b2.click()
                #     sleep(1)
                ...
                #     logging.info(str(divs2.text)+ " - " +str(occupancy))
                #     for i in range(occupancy - int(divs2.text)):
                #         buttons2 = divs2.find_elements_by_tag_name("button")
                #         driver.execute_script("arguments[0].click();", buttons2[1])
                #         # sleep(2)
                #         # driver.execute_script("arguments[0].click();", b2)
                #         # sleep(1)
                #         break
                ...
                #     driver.execute_script("arguments[0].click();", _date)
                #     #_date.click()
                ...
                #                 logging.info("Date aux: "+str(aux_date))
                #                 try:
                #                     if len(aux_date) == 1:
                ...
                #                             #driver.execute_script("arguments[0].dispatchEvent(new MouseEvent('click', { bubbles: true }));console.log(arguments);console.log('Buttons');", _td)
                #                             sleep(5)
                #                             _td.click()
                ...
                logging.info(_url)
                for b in buttons:
                    logging.info("Button Submit: "+str(b.text))
                    if "Search" or "Buscar" in b.text:
                        sleep(1)
                        #b.click()
                ...
                if _error is None:
                    ...
                    #         _button.click()
                    #         logging.info("[+] click ignore information")
                    # except NoSuchElementException as e:
                    ...
                    #             logging.info("[+] click checkbox start")
                    #             break
                    ...
                    #         if "Hoteles" in str(s):
                    #             driver.find_element_by_xpath("//input[@id='"+str(s.get("id"))+"']").click()
                    #             logging.info("[+] click checkbox hoteles")
                    #             break
                    # except NoSuchElementException as e:
                    ...
                    #     logging.info(f"[+] total search: {total_search}")
                    #     #print(total_search)
                    # except NoSuchElementException as e:
